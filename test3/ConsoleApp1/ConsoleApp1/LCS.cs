...
namespace ConsoleApp1
{
    ...
    public class LCS<T>
    {
        ...
        /*   
        LCS算法（Longest Common Subsequence），即：最长公共子序列，它是求两个字符串最长公共子序列的问题。     
        */
        ...
        public override string ToString()
        {
            ...
            //调用StringMatch进行匹配得分
            StringMatch mach = new StringMatch();
            ...
            string output2 = $"替换题：请删除文中所有的文字{strdisn}分：{Count}分";
